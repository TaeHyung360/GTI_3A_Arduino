...
public:
  ...
  // .........................................................
  /**
  * nombreEmisora: Texto, fabricanteID: N, txPower: Texto -> EmisoraBLE()
  * 
  * @param nombreEmisora de tipo texto
  * @param fabricanteID de tipo natural
  * @param txPower de tipo texo
  */
  ...
  */
  ...
  /**
  * carga: texto, tamanyoCarga: texto -> emitirAnuncioBeaconLibre()
  * 
  * @param carga de tipo texto, contiene el contenido a enviar
  * @param tamanyoCarga de tipo texto
  */
